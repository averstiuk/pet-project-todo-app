[DEMO LINK](https://averstiuk.github.io/react_todo-app/)
# React ToDo App
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://averstiuk.github.io/react_todo-app/) and add it to the PR description.
